...
public class Fragment_2 extends Fragment {
    ...
    private void setAnime(){
        ...
        TranslateAnimation animation_translate2 = new TranslateAnimation ( 0, -15, 0, 0 );
        //実行時間
        animation_translate.setDuration ( 1200 );
        animation_translate2.setDuration ( 1200 );
        //反復動作
        animation_translate.setRepeatMode ( Animation.REVERSE );
        animation_translate2.setRepeatMode ( Animation.REVERSE );
        //アニメーションを無限に繰り返す
        animation_translate.setRepeatCount ( Animation.INFINITE );
        animation_translate2.setRepeatCount ( Animation.INFINITE );
        //起動
        imageView.startAnimation ( animation_translate );
        imageView2.startAnimation ( animation_translate2 );
